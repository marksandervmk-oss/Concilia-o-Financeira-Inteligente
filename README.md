...
- Compara extrato e razão por data exata e valor exato; fornecedor e histórico não interferem no match.
...
4. Para cada lançamento do extrato, busca candidatos no razão somente quando a data e o valor são iguais.
5. Calcula score ponderado:
   - Valor: 34%
   - Data: obrigatoriamente igual
